...
def grab_ted_talk_urls(num_pages=10):
    """
    ...
    for page_num in range(1,num_pages+1):
        ...
        res = requests.get("https://www.ted.com/talks?sort=popular&page=" + str(page_num))
...
def extract_process(url):
    ...
    paragraphs = extract_transcript(driver)
...
if __name__== '__main__':
    urls = grab_ted_talk_urls(num_pages=1)
